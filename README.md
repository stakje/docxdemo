...
| 版本 | 更新时间 | 更新内容 |
| --- | --- | --- |
| 0.1.7 | 2026-07-19 | 增加 PDF、Office 兼容视图、系统高保真预览和表格数据视图的内容选择与复制支持。 |
| 0.1.6 | 2026-07-19 | 优化文件显示区域和长文档加载性能；提升 PDF 打开与进程恢复的可靠性；修复 DOCX 图片尺寸和快速切换文件时的竞态问题。 |

完整版本历史、详细新增功能和修复内容见 [项目更新说明](./CHANGELOG.md)。
